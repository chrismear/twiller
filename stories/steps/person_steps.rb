...
def create_person!(person_type, person_params)
  ...
  # fix the person's activation status
  activate_person! if person_type == 'activated'
end

 
def activate_person activation_code=nil
  activation_code = @person.activation_code if activation_code.nil?
  get "/activate/#{activation_code}"
end

def activate_person! *args
  activate_person *args
